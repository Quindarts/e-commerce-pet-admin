...
function HomePage() {
    ...
    return (
        <Box className="xl:grid-rows-5 box-border grid h-full max-h-max gap-7">
            <Box className="xl:row-span-2 xl:grid-cols-4 xl:grid-rows-1 xl:gap-y-0 row-span-1 grid gap-7 xs:grid-rows-6 md:grid-rows-2 lg:grid-rows-6">
                <Box className="xl:col-span-2 xl:grid-cols-2 xl:grid-rows-2 grid gap-7 xs:col-span-4 xs:row-span-4 md:col-span-4 md:grid-cols-2 md:grid-rows-2 lg:col-span-4 lg:row-span-2 lg:grid-cols-4 lg:grid-rows-1">
                    {revenues.map((revenue, index) => (
                        <Box
                            key={index}
                            className="xl:col-span-1 xl:row-span-1 max-h-[134px] min-w-[178px] p-7 xs:col-span-4 xs:row-span-1 md:col-span-1 lg:col-span-1 lg:row-span-1"
                ...
                <Box
                    sx={Card}
                    className="xl:col-span-2 xl:row-span-1 max-h-[288px] p-7 xs:col-span-4 xs:row-span-2 md:col-span-4 lg:col-span-4 lg:row-span-4"
                >
                    <BarChart
                        xAxis={[
                            {
            ...
            <Box className="min-h-6 max-h-auto xl:row-span-3 xl:grid-cols-3 row-span-1 grid grid-cols-5 gap-7">
                <Box sx={Card} className="xl:col-span-2 p-7 xs:col-span-5 md:col-span-5 lg:col-span-3">
                    <Table label="Popular Products" className="h-80 w-auto" columns={columns} rows={rows} />
                </Box>
                <Box sx={Card} className=" xl:col-span-1 p-7 xs:col-span-5 md:col-span-5 lg:col-span-2">
                    <DonutChart />
                </Box>
            </Box>
            <Box className="min-h-6 max-h-auto xl:row-span-3 xl:grid-cols-3 row-span-1 grid grid-cols-5 gap-7">
                ...
                <Box sx={Card} className=" xl:col-span-1 relative p-7 xs:col-span-5 md:col-span-5 lg:col-span-2">
                    ...
                    <Grid className="mt-5" container direction="column" spacing={2}>
                        {orders.map((order, index) => (
                            <Grid item key={index}>
                                <Box className="xl:grid-cols-5 grid gap-2 xs:grid-cols-4 sm:grid-cols-4 sm:text-xs md:grid-cols-10 lg:grid-cols-5">
                                    ...
                                    <Box className="xl:col-span-3 xs:col-span-2 sm:col-span-2 sm:text-xs md:col-span-8 lg:col-span-3">
